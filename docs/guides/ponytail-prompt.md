<!-- This is a copy of the Ponytail - lite prompt to improve code outputs from AI agents. Paste in CLAUDE.md or AGENTS.md
Source: https://github.com/ilindaniel/ponytail-lite
Original creator: https://github.com/DietrichGebert/ponytail
 -->
